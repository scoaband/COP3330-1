...
public class Application {
	 ...
	 * 
	 * account number balance at the beginning of the month total of all items
	 * charged by the customer this month total of all credits applied to the
	 * customer’s account this month allowed credit limit.
	 * 
